...
## 🛠️ Arquitetura do Pipeline e Ferramentas
...
Se o seu objetivo é analisar a discussão científica, as tabelas de impacto clínico e as figuras geradas (PCA, Volcano Plot, Heatmap e GSEA), você não precisa instalar nada:
*   Acesse e inspecione diretamente o arquivo fonte [relatorio.Rmd](relatorio.Rmd) aqui no repositório.
*   
...
*   **Eficiência de Alinhamento:** O mapeamento pelo Salmon apresentou altas taxas de eficiência (métrica `percent_mapped` estável), confirmando a adequação do transcriptoma de referência escolhido.
